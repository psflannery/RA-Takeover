                         ...
                         '<div class="ot-btn-main">' +
                           '<nav class="ot-btn-main-menu">' +
                             ...
                             '<ul id="student-list" class="ot-btn-menu-items" role="group">' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Rian Coughlan" data-placement="left" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Rian Coughlan</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Elliot Dodd" data-placement="left" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Elliot Dodd</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Alana Francis" data-placement="left" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Alana Francis</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Kira Freije" data-placement="left" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Kira Freije</span></button></li>' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Frank Kent" data-placement="left" data-mp3="../sounds/WET_SLOW.mp3" data-tint="#00FFFF"><img src="../img/anon.png"><span class="sr-only">Frank Kent</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Neill Kidgell" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3" data-tint="#FFFF00"><img src="../img/anon.png"><span class="sr-only">Neill Kidgell</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Jack Killick" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3" data-tint="#FF0000"><img src="../img/anon.png"><span class="sr-only">Jack Killick</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Molly Palmer" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Molly Palmer</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Anna Paterson" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Anna Paterson</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Robin Seir" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Robin Seir</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Rafal Topolewski" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Rafal Topolewski</span></button></li>' +
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Claire Undy" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Claire Undy</span></button></li>' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="Tom Worsfold" data-placement="top" data-mp3="../sounds/WET_SLOW.mp3"><img src="../img/anon.png"><span class="sr-only">Tom Worsfold</span></button></li>' +
                             '</ul>' +
                           '</nav>' + 
                         '</div>' +
                       '</div>';
    ...
    function ot_expand_menu() {
        $('[data-toggle="ot-menu"]').on(eventtype, function(e){
            ...
            if(takeover !== true) {
                ...
                $('.converted-to-svg textpath').each(function(){
      ...
      $('[data-toggle="ot-takover"]').on(eventtype, function(e){
        ...
        if(takeover !== true) {
            ...
            $('.convert-to-svg').each(function(i){
                ...
                $(this).replaceWith($('<svg id="converted-' + (i+1) + '" class="converted-to-svg"></svg>'));
                
                // Animate the path
                // http://stackoverflow.com/questions/20206345/loop-an-animation-with-snap-svg
                var s = new Snap('#converted-' + (i+1)),
                    length = Snap.path.getTotalLength(path),
                    animatedText = s.text(500, 250, text).attr({ 'textpath': path, 'font': 'bold 2.25em sans-serif' }).textPath.animate({ 'startOffset': length }, 250000 );
            });
        }
