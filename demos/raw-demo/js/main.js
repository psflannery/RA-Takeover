    ...
    function ot_button_markUp() {
        var paths = {
            ...
            otButton = '<div class="ot-btn-container">' +
                         '<div class="ot-btn-main">' +
                           '<nav class="ot-btn-main-menu">' +
                             ...
                             '<ul id="student-list" class="ot-btn-menu-items" role="group">' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="' + students[1] + '" data-placement="top" data-mp3="../../assets/rian-sound.mp3"><img src="../../assets/rian-button.jpg"><span class="sr-only">' + students[1] + '</span></button></li>' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="' + students[3] + '" data-placement="left" data-mp3="../../assets/' + alanaSound + '"><img src="../../assets/alana-button.jpg"><span class="sr-only">' + students[3] + '</span></button></li>' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="' + students[10] + '" data-placement="top" data-mp3="../../assets/molly-sound.mp3"><img src="../../assets/molly-button.jpg"><span class="sr-only">' + students[10] + '</span></button></li>' +
                               ...
                               '<li><button type="button" data-toggle="ot-takover" data-tooltip="' + students[13] + '" data-placement="top" data-mp3="../../assets/rafal-sound.mp3"><img src="../../assets/rafal-button.jpg"><span class="sr-only">' + students[13] + '</span></button></li>' +
                         ...
                         '</div>' +
                       '</div>';
        $('body').append(otButton, overlay, sounds);
    }
    ...
    function ot_launch_takeOver() {
      $('[data-toggle="ot-takover"]').on(eventtype, function(e){
        ...
        if(takeover !== true) {
            ...
            if ( str === 'claire-undy' ) {
                $overlay.addClass('active undy-pillows-top');
            } else {
                $overlay.removeClass('active undy-pillows-top');
            } 
            ...
            $('h2').each(function(i){
                ...
                $(this).replaceWith($('<svg id="converted-' + (i+1) + '" class="converted-to-svg converted-to-svg-' + (i+1) + '" data-class="' + originalClasses + '" viewBox="0 0 1000 200" preserveAspectRatio="xMidYMid meet""></svg>'));
